      ...
      <Container>
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
          <div>
            ...
            >
              Professional Photo, Video, Podcast & Marketing Studio in Mirpur
          ...
          >
            <div className="grid grid-cols-12 grid-rows-6 gap-3 h-[420px] lg:h-[480px]">
              {heroTiles.map((tile, i) => (
                <motion.div
                  key={i}
                  className={`${tile.col} ${tile.row} rounded-2xl relative overflow-hidden hover:scale-[1.03] transition-transform duration-500 cursor-pointer shine-effect group shadow-soft bg-brand-100`}
        ...
        <div className="py-14 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center relative z-10">
          {STATS.map((stat, i) => (
            <RevealOnScroll key={i} delay={i * 0.1}>
              ...
              <div className="mt-2 text-sm text-white/75 font-body font-medium">
                {stat.label}
              </div>
            </RevealOnScroll>
          ))}
    ...
    <section className="py-24 bg-surface-secondary relative">
      ...
      <Container>
        <SectionHeader
          ...
          subtitle="From photoshoots to podcasts, from reels to full-scale marketing — we've got every creative service covered."
          center
        />
  ...
  return (
    <section className="py-24 relative">
      <Container>
        <SectionHeader
          chip="WHY US"
          title="Why Brands Trust Brand Grow Studio"
          center
        />
        ...
        <RevealOnScroll>
          <div className="py-20 lg:py-24 text-center relative z-10">
            ...
            <p className="mt-4 text-lg text-white/80 font-body">
              Book your studio session or editing project today.
            </p>

            <motion.div className="mt-8" whileHover={{ scale: 1.02 }}>
              <Button href="/contact" variant="whiteFill" size="lg">
