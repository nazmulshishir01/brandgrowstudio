  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl overflow-hidden shadow-soft hover:shadow-heavy transition-all duration-500 hover:-translate-y-2 group">
        <div className="relative overflow-hidden bg-gray-100" style={{ aspectRatio: item.aspect || '16/9' }}>
          {isVideo ? (
            embedUrl ? (
              <iframe
                src={embedUrl}
    ...
    <PageTransition>
      <section className="pt-28 pb-12 bg-brand-50 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(circle at 1px 1px, #3CC76A 1px, transparent 0)',
