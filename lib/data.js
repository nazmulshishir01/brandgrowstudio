...
export const PORTFOLIO_ITEMS = [
  { type: 'video', category: 'UGC & Ads', title: 'Client UGC Ad — Product Showcase', description: 'Short-form UGC ad for a Dhaka-based lifestyle brand', aspect: '16/9' },
  { type: 'video', category: 'UGC & Ads', title: 'UGC Testimonial — Skincare Brand', description: 'Authentic user-generated content for social campaigns', aspect: '16/9' },
  { type: 'video', category: 'Reels & Shorts', title: 'Instagram Reels — Fashion Brand', description: 'Trending reels edit with motion graphics and color grade', aspect: '9/16' },
  { type: 'video', category: 'Reels & Shorts', title: 'TikTok Viral Short — Food Brand', description: 'Fast-paced editing with trendy transitions and sound', aspect: '9/16' },
  { type: 'video', category: 'Podcast', title: 'Podcast Episode — Full Production', description: 'Full podcast video edit with lower thirds and color grade', aspect: '16/9' },
  { type: 'video', category: 'Podcast', title: 'Interview Podcast — Tech Talk', description: 'Multi-camera podcast with animated overlays', aspect: '16/9' },
  { type: 'video', category: 'Long Form Edits', title: 'YouTube Long Form — Tech Review', description: 'Complete YouTube video edit with intro, transitions, and thumbnail', aspect: '16/9' },
  { type: 'video', category: 'Long Form Edits', title: 'Documentary Style — Brand Story', description: 'Cinematic brand documentary with voiceover and B-roll', aspect: '16/9' },
  { type: 'photo', category: 'Product Photography', title: 'Product Shoot — Cosmetics Brand', description: 'Professional product photography with creative styling', aspect: '3/4' },
  { type: 'photo', category: 'Product Photography', title: 'E-Commerce Flatlays — Accessories', description: 'Clean e-commerce ready product shots', aspect: '1/1' },
  { type: 'photo', category: 'Brand Shoots', title: 'Brand Photography — Clothing Label', description: 'Lifestyle brand photography with models', aspect: '3/4' },
  { type: 'photo', category: 'Brand Shoots', title: 'Corporate Headshots — Tech Startup', description: 'Professional team portraits and branding photos', aspect: '1/1' },
  { type: 'photo', category: 'Product Photography', title: 'Food Photography — Restaurant Menu', description: 'Appetizing food photography for digital menus', aspect: '4/3' },
  { type: 'photo', category: 'Brand Shoots', title: 'Fitness Brand Shoot — Gymwear', description: 'Dynamic fitness photography with studio lighting', aspect: '3/4' },
];
